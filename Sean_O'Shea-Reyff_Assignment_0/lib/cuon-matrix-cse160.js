...
class Vector3 {
    ...
    static cross(other1, other2) {
        ...
        h1 = (v1[1] * v2[2]) - (v1[2] * v2[1]);
        h2 = (v1[2] * v2[0]) - (v1[0] * v2[2]);
        h3 = (v1[0] * v2[1]) - (v1[1] * v2[0]);
        // This function should create and return a new vector.
        let v3 = new Vector3([h1, h2, h3]); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        ...
        for (i = 0; i < 3; ++i) {
          vectorSquare += this.elements[i] * this.elements[i];
        }

        let m = Math.sqrt(vectorSquare); // Modify this line to calculate this vector's magnitude.
    ...
    normalize() {
        ...
        // This function should change this vector (this.elements) and not create a new vector.
        this.elements;
        var vectorTotal = this.magnitude();
        var i;

        for(i = 0; i < 3; ++i){
          this.elements[i] = this.elements[i] / vectorTotal;
        }
